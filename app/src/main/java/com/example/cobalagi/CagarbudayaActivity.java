...
public class CagarbudayaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cagarbudaya);


        recyclerView = findViewById(R.id.listcag);
        database = FirebaseDatabase.getInstance().getReference("cagar_budaya");
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        list = new ArrayList<>();
        searchView = findViewById(R.id.simpleSearchView);

        ProgressDialog Dialog = new ProgressDialog(CagarbudayaActivity.this);
        Dialog.setMessage("Menampilkan Cagar Budaya ....");
        Dialog.show();
